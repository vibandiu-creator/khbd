...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Vi - Trường Tiểu học Nà Chì - ĐT: 097 1986 343</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Vi- Trường Tiểu học Nà Chì - ĐT: 097 1986 343</div>", unsafe_allow_html=True)
